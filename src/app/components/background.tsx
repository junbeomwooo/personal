...
export default function Background() {
  ...
  return (
    ...
    <Canvas shadows dpr={[1, 1.5]} camera={{ position: [-1.5, 1, 5.5], fov: 45, near: 1, far: 20 }} eventSource={document.getElementById('root') || undefined} eventPrefix="client"   style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0, zIndex:0}}>
      {/* Lights */}
      <color attach="background" args={[`${theme === 'light'? "#e2c291" : "black"}`]} />
      <hemisphereLight intensity={0.15} groundColor={`${theme === 'light'? "#e2c291" : "black"}`} />
