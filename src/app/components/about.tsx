    ...
    <AnimatePresence>
      <div className="h-full w-full relative m-0 p-0">
        ...
        >
                ...
                >
                  {locale === "en" ? (
                    <h3 className="text-[13px] sm:text-[15px] md:text-[18px] xl:text-[20px] leading-[20px] sm:leading-[24px] xl:leading-[34px] overflow-y-auto">
                      ...
                      <br />I have moved to Denmark in late March 2024 and I am
                      currently seeking employment in Copenhagen.
                    </h3>
                  ) : (
                    <h3 className="text-[13px] sm:text-[15px] md:text-[18px] xl:text-[20px] leading-[20px] sm:leading-[24px] xl:leading-[34px] overflow-y-auto">
                      ...
                      <br />
                      <br />
                      Jeg har opnået en bachelorgrad i visuel design i Sydkorea
                      og fortsatte mine studier på et 6-måneders Full-Stack
                      kode-bootcamp med fokus på grundlæggende viden om
                      webudvikling.
                      <br />
          ...
          {/* Second: Skills */}
          <SwiperSlide className="w-full h-screen">
            <div className="w-full h-screen pt-[135px] md:pt-[220px] xl:pt-0 block xl:flex px-6 md:px-10 lg:px-40 justify-center items-center">
              {/* Skills */}
              <div className="w-full xl:w-3/5 mt-14 sm:mt-0">
                {/* funtion Skills() */}
                <motion.div
                  className="flex items-end"
                  initial={{ opacity: 0, y: "-35%" }}
                ...
                <div className="font-medium text-sm ">
                  ...
                  <div>
                    ...
                    <motion.div
                      ...
                      initial={{ width: "0%" }}
                      animate={{ width: secondSlideAnimation ? "100%" : "0%" }}
